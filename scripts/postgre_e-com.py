...
dp_password = getpass.getpass("Introduce tu contraseña de postgreSql: ")
...
def inicializar_conexion():
    ...
    print(f"conectado a PostgreSQL: Base de datos {DB_CONFIG['database']}")
    return conn


def generar_tablas_postgresql(conn):
